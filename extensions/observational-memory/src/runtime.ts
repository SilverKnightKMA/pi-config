...
export class Runtime {
	...
	/**
	 * RPC-safe status sink (Paseo timeline via custom messages). Null-object until
	 * {@link wireTimeline} is called with the live ExtensionAPI, so Runtime stays
	 * constructible in unit tests without a pi instance.
	 */
	timeline: TimelineSink = makeNullTimelineSink();
